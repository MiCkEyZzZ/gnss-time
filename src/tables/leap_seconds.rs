...
// * 1e9             = 252_028_824_000_000_000   1990-01-01 unix = 631_152_000
// → (315187200  + 25) * 1e9             = 315_187_225_000_000_000   1991-01-01
// unix = 662_688_000   → (346723200  + 26) * 1e9             =
// 346_723_226_000_000_000   1992-07-01 unix = 709_948_800   → (393984000  + 27)
// * 1e9             = 393_984_027_000_000_000   1993-07-01 unix = 741_484_800
// → (425520000  + 28) * 1e9             = 425_520_028_000_000_000   1994-07-01
// unix = 773_020_800   → (457056000  + 29) * 1e9             =
// 457_056_029_000_000_000   1996-01-01 unix = 820_454_400   → (504489600  + 30)
// * 1e9             = 504_489_630_000_000_000   1997-07-01 unix = 867_715_200
// → (551750400  + 31) * 1e9             = 551_750_431_000_000_000   1999-01-01
// unix = 915_148_800   → (599184000  + 32) * 1e9             =
// 599_184_032_000_000_000   2006-01-01 unix = 1_136_073_600 → (820108800  + 33)
// * 1e9             = 820_108_833_000_000_000   2009-01-01 unix = 1_230_768_000
// → (914803200  + 34) * 1e9             = 914_803_234_000_000_000   2012-07-01
// unix = 1_341_100_800 → (1025136000 + 35) * 1e9             =
// 1_025_136_035_000_000_000   2015-07-01 unix = 1_435_708_800 → (1119744000 +
// 36) * 1e9             = 1_119_744_036_000_000_000   2017-01-01 unix =
// 1_483_228_800 → (1167264000 + 37) * 1e9             =
